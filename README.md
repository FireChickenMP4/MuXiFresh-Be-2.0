...
- **引用**：`replace github.com/zeromicro/go-zero => github.com/Muxi-X/go-zero v1.4.5-muxi.1`
- **补丁仓库**：[Muxi-X/go-zero](https://github.com/Muxi-X/go-zero)（分支 `muxi-patch`，tag `v1.4.5-muxi.1`，[diff](https://github.com/Muxi-X/go-zero/compare/v1.4.5...muxi-patch)）
